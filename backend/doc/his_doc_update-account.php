<?php
	...
	include('assets/inc/config.php');
        ...
        if(isset($_POST['update_pwd']))
        {
            ...
            $new_doc_pwd = sha1(md5($_POST['doc_pwd'])); // New Password
            $old_doc_pwd = sha1(md5($_POST['old_doc_pwd'])); // Old Password entered by user
            $re_doc_pwd = sha1(md5($_POST['re_doc_pwd'])); // Re-entered Password for confirmation
            ...
            $stmt->execute();
            $stmt->bind_result($doc_pwd_db);
            $stmt->fetch();
            $stmt->free_result(); // Clear the result set
        
            // Verify old password entered by user with password in database
            if($doc_pwd_db != $old_doc_pwd)
            {
                $err = "Old Password Incorrect";
            }
            else if($re_doc_pwd != $new_doc_pwd)
            {
                $err = "Confirm Password does not match with New Password";
            }
            else
            {
                // Update password
                ...
                $stmt = $mysqli->prepare($query);
                $stmt->bind_param('si', $new_doc_pwd, $doc_number);
                $stmt->execute();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="doc_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->doc_fname;?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="doc_email" class="form-control" id="useremail" placeholder="<?php echo $row->doc_email;?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" name="doc_dpic" class="form-control btn btn-success" id="useremail" required>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" name="old_doc_pwd" id="firstname" placeholder="Enter Old Password" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">New Password</label>
                                                                <input type="password" class="form-control" name="doc_pwd" id="lastname" placeholder="Enter New Password" required>
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" name="re_doc_pwd" id="useremail" placeholder="Confirm New Password" required>
                                                    </div>
