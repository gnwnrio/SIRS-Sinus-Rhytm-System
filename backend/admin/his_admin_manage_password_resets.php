                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <?php
                                                ...
                                                while($row=$res->fetch_object())
                                                {
                                                    ...
                                                    {
                                                        $action = "<td><a href='his_admin_update_doc_password.php?email=$row->email&pwd=$row->pwd&token=$row->token' class='badge badge-danger'><i class='fas fa-edit'></i>Reset Password</a></td>";
                                                    }
                                                    else
                                                    {
