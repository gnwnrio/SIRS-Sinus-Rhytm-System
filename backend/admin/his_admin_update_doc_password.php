        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                            $pwd=$_GET['pwd'];
                            $ret="SELECT  * FROM his_pwdresets WHERE pwd=?";
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$pwd);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
                            //$cnt=1;
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required="required" type="email"
                                                    ...
                                                    name="doc_email" id="inputCity">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">Password</label>
                                                <input required="required" type="text" value="<?php echo $row->pwd;?>"
                                                    name="doc_pwd" class="form-control" id="inputCity">
                                            </div>
                                            <div class="form-group col-md-6" style="display:none">
                                                <label for="inputCity" class="col-form-label">Reset Status</label>
                                                <input required="required" type="text" value="Reset" name="status"
                                        ...
                                        <button type="submit" name="update_doc" class="ladda-button btn btn-success"
                                            data-style="expand-right">Update Password</button>
