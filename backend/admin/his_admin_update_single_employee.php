                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <div>
                                        <a href="his_admin_manage_employee.php" class="btn btn-danger ml-2" style="width: 80px; height: 40px; margin-top: 20px; margin-right: 20px">Back</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="doc_number" value="<?php echo $row->doc_number; ?>">
                                            <div class="form-row">
